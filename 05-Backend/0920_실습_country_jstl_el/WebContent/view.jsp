...
<body>
	<h1>나라 상세 조회</h1>
	<a href="${pageContext.request.contextPath}/country?action=list">목록</a>
	<table>
		<tr>
			<th>나라코드</th>
			<th>국가명</th>
	...
	<a href="${pageContext.request.contextPath}/country?action=mvUpdate&code=${country.code}">수정 화면 이동</a>
